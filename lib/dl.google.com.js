...
export const getReleases = async function (url, urlPattern, artifactPattern) {
  ...
  if (urls.filter(predicate).length === 2) {
    urls[urls.findIndex(predicate)] = new URL('https://dl.google.com/developers/android/cinnamonbun/images/gsi/aosp_x86_64-exp-CP31.260423.012.A1-15327290-ac4df0a4.zip')
  }
